...
const SideNavMenu = ({ categories, selectedCategory, onSelectCategory }) => {
  return (
    <div className=" rounded-full border-2 border-yellow-100  px-0 py-0 md:p-4 lg:w-1/6 lg:rounded-lg lg:bg-white">
      {/* <h2 className="mb-4 text-center text-lg font-bold">Menu</h2> */}
      <ul className="flex flex-row justify-center md:gap-4 lg:flex-col">
